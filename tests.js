function languageTransfer() {
    ...
    const English = document.getElementById("optionEnglish")
...
function languageTransferDeutsch() {

    const Deutsch = document.getElementById("optionDeutsch")
